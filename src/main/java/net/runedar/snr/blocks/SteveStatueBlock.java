...
public class SteveStatueBlock extends TallStatue{
	...
	static {
		...
		VOXEL_SHAPE_NORTHU = VoxelShapes.cuboid(0f, -1f, 0.2f, 1f, 1f, 0.8f);
		VOXEL_SHAPE_WESTU = VoxelShapes.cuboid(0.2f, -1f, 0f, 0.8f, 1f, 1f);
	}
}