...
public class BlazeStatueBlock extends TallStatue{
      public BlazeStatueBlock() {
	...
	static {
		VOXEL_SHAPE_NORTH = VoxelShapes.cuboid(0.1f, 0f, 0.1f, 0.9f, 1.75f, 0.9f);
		VOXEL_SHAPE_WEST = VoxelShapes.cuboid(0.1f, 0f, 0.1f, 0.9f, 1.75f, 0.9);
		VOXEL_SHAPE_NORTHU = VoxelShapes.cuboid(0.1f, -1f, 0.1f, 0.9f, 0.75f, 0.9f);
		VOXEL_SHAPE_WESTU = VoxelShapes.cuboid(0.1f, -1f, 0.1f, 0.9f, 0.75f, 0.9);
	}
}