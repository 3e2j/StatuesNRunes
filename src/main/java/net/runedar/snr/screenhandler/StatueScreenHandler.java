...
public class StatueScreenHandler extends ScreenHandler {
      ...
      public StatueScreenHandler(int syncId, PlayerInventory playerInventory) {
          this(syncId, playerInventory, new SimpleInventory(1));
      }

      //from BlockEntity calls this, server displays
      public StatueScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory) {
          super(SnR.STATUE_SCREEN_HANDLER, syncId);
